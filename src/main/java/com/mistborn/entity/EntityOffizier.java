...
public class EntityOffizier extends EntityMob{

	public EntityOffizier(World world) {
	...
	public void onLivingUpdate(){
		...
		this.getEntityAttribute(SharedMonsterAttributes.maxHealth).setBaseValue(42);

...
public class zinn extends Item{
	public zinn(int id){
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
		...
		//if (entity.inventory.hasItem(Mistborn.zinn) == true){
			entity.addPotionEffect(new PotionEffect(Potion.nightVision.id, 30000, 3));
			entity.addPotionEffect(new PotionEffect(Potion.moveSpeed.id, 30000, 3));

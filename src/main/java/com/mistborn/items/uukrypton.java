...
public class uukrypton extends Item{
	public uukrypton(int id){
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
		...
		//if (entity.inventory.hasItem(Mistborn.krypton) == true){
			entity.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 4000, 50));

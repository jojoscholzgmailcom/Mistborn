...
public class ragonium extends Item{
	public ragonium(int id){
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
		...
		if (entity.inventory.hasItem(Mistborn.ragonium) == true){
			entity.addPotionEffect(new PotionEffect(Potion.regeneration.id, 120, 1));

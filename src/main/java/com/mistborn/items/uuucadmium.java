...
public class uuucadmium extends Item{
	public uuucadmium(int id){
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
		...
		//if (entity.inventory.hasItem(Mistborn.ucadmium) == true){
			...
			entity.addPotionEffect(new PotionEffect(Potion.moveSlowdown.id, 300000, 5));

...
public class uuuzink extends Item{
	public uuuzink(int id){
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer entity) {
		...
		//if (entity.inventory.hasItem(Mistborn.uzink) == true){
			...
			entity.addPotionEffect(new PotionEffect(Potion.fireResistance.id, 120, 3));
